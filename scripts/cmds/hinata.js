...
module.exports = {
  ...
  onChat: async function ({ api, event }) {
    const responses = [
      ...
      "🐒🐒🐒",
      "bye",
      "naw message daw m.me/doremon.bhai.2024",
      "mb ney bye",
      "meww",
      ...
      "𝗕𝗯𝘆 𝗕𝗯𝘆 না করে আমার বস মানে, Gojo Orupe Piw Piw ,Gojo Orupe Piw Piw ও তো করতে পারো😑?",
      ...
      "কথা দেও আমাকে পটাবা...!! 😌",
      "বার বার Disturb করেছিস কোনো 😾, আমার জানু গোজো অরুপে পিউ পিউ এর সাথে ব্যাস্ত আসি 😋",
      ...
      " মেয়ে হলে আমার বস গোজো অরুপে পিউ পিউ এর সাথে প্রেম করো🥵🫶",
      "তুই কি 👉Single meye👈..?, তা হলে আমার বস গোজো অরুপে পিউ পিউ কে প্রেম এর প্রস্তাব দে 😉",
      "𝗛𝗶 𝗔𝗺𝗶 𝗣𝗶𝘄 𝗣𝗶𝘄 𝗖𝗵𝗮𝘁 𝗕𝗼𝘁, 𝗔𝗺𝗮𝗿 𝗕𝗼𝘀𝘀 𝗚𝗼𝗷𝗼 𝗢𝗿𝘂𝗽𝗲 𝗣𝗶𝘄 𝗣𝗶𝘄😇🥰",
      "বলো ডারলিং পিউ পিউ চেট বট তোমার জন্য কি করতে পারি..?"
    ];
