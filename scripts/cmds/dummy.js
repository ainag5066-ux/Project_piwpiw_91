...
module.exports = {
 ...
 if (args.length === 0)
 return message.reply("❗ Please provide text. Example: `+dummy Hello world red`");
 ...
 return message.reply("❗ Please provide text before the background color.");
 ...
 writer.on("finish", () => {
 message.reply({
 body: `🖼️ Piw Piw Chat Bot Dummy image generated with background color \`${bgColor}\`:\n📝 *${decodeURIComponent(text)}*`,
 ...
 console.error(e);
 message.reply("⚠️ Piw Piw Chat Bot Failed to fetch dummy image.");
 }
 }
};
